...
for N in 2:40
    ...
    d = calculate_full_phase_data(N; bdg=true, save=true, res=(2, 2), fixedparams, MaxTime=10N, target, optimize=true, exps=range(0.1, 4, 5), folder="ss_bdg_noexcgap_bestof", final_NM=false, minexcgap=0, alg, initials=initials[1])
