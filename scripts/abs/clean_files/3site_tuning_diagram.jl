...
## Save data
wsave(datadir("final_data", "3-site-tuning2.jld2"), Dict("data" => data, "ss_deg" => ss_deg, "ss_nodeg" => ss_nodeg, "εs" => εs, "δϕs" => δϕs, "fixedparams" => fixedparams, "N" => N, "res" => res, "target" => target, "bdg" => bdg))
## Load data
data_dict = load(datadir("final_data", "3-site-tuning2.jld2"));
...
fig = with_theme(theme_latexfonts()) do
    ...
    hmap = heatmap!(ax, εs, δϕs, map(LD, data)'; colormap=Reverse(:viridis), colorscale=identity, colorrange=(0, 1))
